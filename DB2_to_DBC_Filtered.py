    ...
    for entry in model_data:
        ...
        if filedata_id in selected_fileids:
            ...
            output_entry = {
                ...
                'SizeClass': entry.get('sizeclass', ''),
                'ModelScale': entry.get('modelscale', ''),
                'BloodID': entry.get('bloodid', ''),
                'FootprintTextureID': entry.get('footprinttextureid', ''),
                'FootprintTextureLength': entry.get('footprinttexturelength', ''),
                'FootprintTextureWidth': entry.get('footprinttexturewidth', ''),
                'FootprintParticleScale': entry.get('footprintparticlescale', ''),
                'FoleyMaterialID': entry.get('foleymaterialid', ''),
                'FootstepShakeSize': entry.get('footstepcameraeffectid', ''),
                'DeathThudShakeSize': entry.get('deatththudcameraeffectid', ''),
                'SoundID': entry.get('soundid', ''),
                'CollisionWidth': entry.get('collisionwidth', ''),
                'CollisionHeight': entry.get('collisionheight', ''),
                'MountHeight': entry.get('mountheight', ''),
                'GeoBoxMinX': entry.get('geobox_0', ''),
                'GeoBoxMinY': entry.get('geobox_1', ''),
                'GeoBoxMinZ': entry.get('geobox_2', ''),
                'GeoBoxMaxX': entry.get('geobox_3', ''),
                'GeoBoxMaxY': entry.get('geobox_4', ''),
                'GeoBoxMaxZ': entry.get('geobox_5', ''),
                'WorldEffectScale': entry.get('worldeffectscale', ''),
                'AttachedEffectScale': entry.get('attachedeffectscale', ''),
                'MissileCollisionRadius': entry.get('missilecollisionradius', ''),
                'MissileCollisionPush': entry.get('missilecollisionpush', ''),
                'MissileCollisionRaise': entry.get('missilecollisionraise', '')
            }
